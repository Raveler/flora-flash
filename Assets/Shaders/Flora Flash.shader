...
Shader "Flora Flash"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_90_0 = ( t45 * ( -2.0 * UNITY_PI ) );
			float2 normalizeResult60 = normalize( ( temp_output_35_0 - temp_output_32_0 ) );
			float3 rotatedValue95 = RotateAroundAxis( float3( 0,0,0 ), float3( normalizeResult60 ,  0.0 ), float3( 0,0,1 ), temp_output_90_0 );
			float2 appendResult98 = (float2(rotatedValue95.xy));
			float2 break64 = appendResult98;
			float temp_output_78_0 = ( atan2( break64.x , break64.y ) + UNITY_PI );
			float angle62 = temp_output_78_0;
			float temp_output_69_0 = ( angle62 / ( 2.0 * UNITY_PI ) );
			float lerpResult7_g1 = lerp( 1.0 , 0.0 , (0.0 + (abs( ( temp_output_69_0 - 0.5 ) ) - 0.0) * (1.0 - 0.0) / (0.5 - 0.0)));
			float lerpResult80 = lerp( 0.5 , 1.5 , temp_output_69_0);
			float lerpResult56 = lerp( ( 4.0 * UNITY_PI ) , ( 50.0 * UNITY_PI ) , pow( t45 , 2.0 ));
			o.Alpha = ( lerpResult7_g1 * pow( ( ( 1.0 - clampResult10 ) * (0.0 + (sin( ( lerpResult80 * ( distance47 * lerpResult56 ) ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ) , 0.5 ) );
		}
...
/*ASEBEGIN
Version=18935
107;297;1438;842;1423.032;231.5495;1.570498;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;40;-3322.82,-951.1948;Inherit;False;2471.847;823.1868;Calculate Flash Point Distznce;20;26;1;33;32;5;31;34;35;9;24;23;8;10;47;59;61;64;65;78;79;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;89;-1748.871,-1241.039;Inherit;False;45;t;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.PiNode;91;-1788.208,-1123.551;Inherit;False;1;0;FLOAT;-2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;-1580.128,-1188.342;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;60;-1543.079,-1075.24;Inherit;False;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RotateAboutAxisNode;95;-1387.235,-1162.17;Inherit;False;False;4;0;FLOAT3;0,0,1;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DynamicAppendNode;98;-1054.022,-1076.553;Inherit;False;FLOAT2;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;62;-849.8923,-759.7099;Inherit;False;angle;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;80;-1373.833,92.76289;Inherit;False;3;0;FLOAT;0.5;False;1;FLOAT;1.5;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;88;-627.0882,-12.73073;Inherit;False;PingPong;-1;;1;9795e93102d424149a8da396e1e0383d;0;3;8;FLOAT;1;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;92;281.2036,-557.0209;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;87;-20.48952,92.76479;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=334178290C541A2E04380BE6E6533E8F06249534